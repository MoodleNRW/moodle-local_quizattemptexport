...
$string['nav_exportoverview'] = 'Quiz PDF export';
$string['page_overview_title'] = 'Exports for "{$a}"';
$string['page_overview_attemptedreexport'] = 'Tried to export the attempt again.';
...
$string['setting_mathjaxdelay_desc'] = 'Using the MathJax typesetting requires a processing delay for each PDF being generated that allows for MathJax to finish processing/typesetting. The default value should cover most cases. If your quiz instances contain a lot of math input and not all of that input was typeset, it might be necessary to set this to a higher value.';
...
$string['template_usersattemptslist_description'] = '<p>Here, you can generate PDF reports for your participants\' quiz attempts.</p><p>The creation of the PDF files takes time, depending on the size and complexity of the quiz.<br>In most cases the average duration is between 10 and 30 seconds per PDF file. <br>The process runs in the background, when you have pressed the button. Please be patient.<br>If you don\'t see any changes after waiting for at least 60 seconds per quiz attempt, please refresh the site in your browser.</p>
<p>You can also download all exported PDF files as a ZIP archive with just one click on the button.</p>';
