...
$string['setting_catfilter_desc'] = 'Select the course categories where the automatic quiz attempt export should be enabled. Only attempts of quiz instances within courses that are associated with a category selected here will be exported automatically. Selecting a category will also implicitly select its subcategories. <br><br> You may select multiple categories by using CTRL+Click.';
