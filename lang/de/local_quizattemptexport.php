...
$string['setting_catfilter_desc'] = 'Wählen Sie die Kurskategorien innerhalb derer der automatische Export aktiv sein soll. Es werden nur solche Quizversuche automatisch exportiert, die in Kursen stattfinden die mit einer der hier ausgewählten Kategorien verknüpft sind. Unterkategorien von Kategorien die ausgewählt wurden, sind implizit mit ausgewählt. <br><br>Nutzen Sie STRG+Mausklick um mehrere Kurskategorien auszuwählen.';
